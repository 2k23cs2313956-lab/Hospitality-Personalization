...
if st.button("Confirm Booking"):
    if name and customer_id:
        ...
        customer_features = pd.read_excel("Task2/Files/customer_features.xlsx")
        cuisine_features = pd.read_excel("Task2/Files/cuisine_features.xlsx")
        cuisine_popular_dish = pd.read_excel("Task2/Files/cuisine_popular_dish.xlsx")

        encoder = joblib.load("Task2/Files/encoder.pkl")
        label_encoder = joblib.load("Task2/Files/label_encoder.pkl")
        model = joblib.load("Task2/Files/xgb_model_dining.pkl")

        features = list(pd.read_excel("Task2/Files/features.xlsx")[0])
